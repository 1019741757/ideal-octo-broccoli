...
<div>
  <div class="wrapper wrapper-content animated fadeInRight" id="inner-content">
    ...
    <Owner-Equipment-Body></Owner-Equipment-Body>
    <Owner-Equipment-Header></Owner-Equipment-Header>
  </div>
</div>
</template>
<script>
...
import OwnerEquipmentBody from './OwnerGeneralization/OwnerEquipmentBody.vue'
import OwnerEquipmentHeader from './OwnerGeneralization/OwnerEquipmentHeader.vue' //设备详情


export default {
  name: 'OwnerGeneralization',
  data() {
    return {
