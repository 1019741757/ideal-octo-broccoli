module.exports = function (classes){
  ...
  var
     ...
     */
      ...
      construct    : function ($super, port, host,agencyKey,user_id,identity_type){
        $super();
      ...
      connectHttp  : function (method, params, opts, callback){
        ...
        headers['Content-Length'] = Buffer.byteLength(requestJSON, 'utf8');
         if(this.user_id!=null){
            headers['user_id'] =this.user_id;
         }
         if(this.agencyKey!=null){
            headers['agencyKey'] =this.agencyKey;
         }
         if(this.identity_type!=null){
            headers['identity_type'] =this.identity_type;
         }

           headers["proxyKey"] = '654321';
